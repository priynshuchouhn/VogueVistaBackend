  ...
  const emailOptions = {
    ...
    html: ` <!DOCTYPE html
      ...
      <head>
        ...
        <title>Vogue Vista - Order confirmation</title><!--[if (mso 16)]>
          <style type="text/css">
                              ...
                              <tr>
                                <td class="es-m-p0r" valign="top" align="center" style="padding:0;Margin:0;width:560px">
                                  <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                    <tr>
                                      <td align="center" style="padding:0;Margin:0;padding-bottom:10px;font-size:0px"><a
                                          target="_blank" href="https://app.voguevista.live"
                                          style="mso-line-height-rule:exactly;text-decoration:underline;color:#666666;font-size:14px"><img
                                            ...
                                            width="300" title="Logo" class="adapt-img" height="75"></a></td>
                                    </tr>
                                  </table>
                                </td>
                              </tr>
                                      ...
                                      <td align="center" class="es-m-txt-c" style="padding:0;Margin:0">
                                        <h2
                                          ...
                                          Order&nbsp;<a target="_blank"
                                            style="mso-line-height-rule:exactly;text-decoration:underline;color:#e09145;font-size:26px"
                                            href="">#<span style="color:#e09145">${orderData.orderNumber}</span></a></h2>
                                      </td>
                                    </tr>
                                    <tr>
                                  ...
                                  <table cellpadding="0" cellspacing="0" width="100%"
                                    ...
                                    <tr>
                                      <td align="right" class="es-m-txt-r"
                                        ...
                                        <p
                                          style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                          Subtotal:&nbsp;<strong>&#8377;${orderData.totalAmount}</strong><br>Shipping:&nbsp;<strong>&#8377;${orderData.shippingCharges}</strong><br>Discount:&nbsp;<strong>&#8377;${orderData.discount}</strong><br>
                                        </p>
                                      </td>
                                    </tr>
                                  </table>
                                  ...
                                  <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                                    ...
                                    <tr>
                                      <td align="left" style="padding:0;Margin:0">
                                        <p
                                          style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                          Customer: <strong>${orderData.shippingAddress.name}</strong></p>
                                        <p
                                          style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                          Order number:&nbsp;<strong>#${orderData.orderNumber}</strong></p>
                                        <p
                                          style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                          Invoice date:&nbsp;<strong>${formattedDate}</strong></p>
                                        <p
                                          style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                          Payment method:&nbsp;<strong>${orderData.paymentMethod}</strong></p>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                                  ...
                                  <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                                    ...
                                    <tr>
                                      <td align="left" class="es-m-txt-l" style="padding:0;Margin:0">
                                        ...
                                        <p
                                          style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                          <strong>${orderData.shippingAddress.addressLine1},<br>${orderData.shippingAddress.city},<br>${orderData.shippingAddress.state}, IN , ${orderData.shippingAddress.pincode}</strong></p>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                                      ...
                                      <td align="center" style="padding:0;Margin:0;padding-bottom:10px;padding-top:10px">
                                        <p
                                          ...
                                          Got a question?&nbsp;Email us at&nbsp;<a target="_blank" href=""
                                            ...
                                            target="_blank" href=""
                                            style="mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px">voguevista</a><a
                                            target="_blank" href=""
                                            style="mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px">.live</a>&nbsp;or
                                          give us a call at&nbsp;<a target="_blank" href=""
                                            style="mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px">+91 9998880000</a>.</p>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                                    ...
                                    <tr>
                                      <td align="center" style="padding:0;Margin:0;padding-bottom:35px">
                                        <p
                                          ...
                                          Vogue Vista&nbsp;© 2024 Vogue Vista, Inc. All Rights Reserved.</p>
                                        <p
                                          style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#333333;font-size:12px">
                                          Old Housing Board, Pali, Rajasthan, IN, 306401</p>
                                      </td>
                                    </tr>
                                    <tr>
